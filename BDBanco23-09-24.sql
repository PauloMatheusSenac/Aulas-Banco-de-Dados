...
END;
$
CREATE TRIGGER triggersaque BEFORE INSERT ON saques
FOR EACH ROW
BEGIN
    DECLARE saldo_atual DECIMAL(10, 2);
    SELECT saldo INTO saldo_atual FROM clientes WHERE idcliente = NEW.idcontacliente;
    IF saldo_atual < NEW.valordosaque THEN
...
SELECT nome, saldo FROM clientes;
INSERT INTO saques (idagencia, idcontacliente, valordosaque) VALUES (1, 1, 100.00);
SELECT nome, saldo FROM clientes;
INSERT INTO depositos (idagencia, idcontacliente, valordodeposito) VALUES (1, 1, 200.00);
SELECT nome, saldo FROM clientes;
SELECT * FROM saques;
SELECT * FROM depositos;
INSERT INTO saques (idagencia, idcontacliente, valordosaque) VALUES (1, 1, 2000.00); -- ajuste o valor conforme necessário
SELECT nome, saldo FROM clientes;
